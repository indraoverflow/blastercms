...
(function(c) {
	...
	c.extend(c.validator, {
		...
		messages : {
			...
			email : "Harap masukkan alamat email yang sah.",
			url : "Harap masukkan URL yang sah.",
			date : "Silakan masukkan tanggal yang sah.",
			dateISO : "Silakan masukkan tanggal yang sah (ISO).",
			number : "Silakan masukkan nomor yang sah.",
			digits : "Silakan masukkan angka saja.",
			creditcard : "Silakan masukkan nomor kartu kredit yang sah.",
			equalTo : "Silahkan masukkan nilai yang sama lagi.",
			accept : "Masukkan nilai dengan ekstensi yang sah.",
			maxlength : c.validator.format("Silakan masukkan tidak lebih dari {0} karakter."),
			minlength : c.validator.format("Silakan masukkan sedikitnya {0} karakter."),
			rangelength : c.validator.format("Masukkan nilai antara {0} dan {1} karakter."),
			range : c.validator.format("Masukkan nilai antara {0} dan {1}."),
			max : c.validator.format("Masukkan nilai kurang dari atau sama dengan {0}."),
			min : c.validator.format("Masukkan nilai yang lebih besar dari atau sama dengan {0}.")
		},
